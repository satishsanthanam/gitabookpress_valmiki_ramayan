...
# - Assigns 'audio_file': 'ramayana/Aranyakanda/{sarga}_0.mp3' for Sarga summaries.
# - Cleans stray OCR artifacts, page headers, page numbers, and footnote asterisks.

import json
import re

INPUT_MD_FILE = "aranyakanda_mistral_ocr.md"
OUTPUT_JSON_FILE = "data/Valmiki_Ramayan_Aranyakanda.json"
KANDA_NAME = "Aranya Kanda"
KANDA_FOLDER = "Aranyakanda"
